...
export default function Courses() {
  ...
  return (
    <>
      <h4 className='classic_heading'>Courses</h4> <AddCourse />
      <h4 className="classic_SUBheading">Allotted Courses</h4>
<div className="ag-theme-alpine" style={{ 
    ...
    />
      ...
      <h4 className="classic_SUBheading">Suggested Courses</h4>
<div className="ag-theme-alpine" style={{ 
    height: "350px", 
    width: "100%" 
}}>
